...
if(WITHOUT_GIT)
  set(rev_date "2019-05-03 16:00:00 -3000")
  set(rev_hash "5CentsCore")
  ...
  if(NOT rev_info)
    ...
    Continuing anyway - note that the versionstring will be set to \"5CentsCore 2019-05-03 16:00:00 (Released)\"")
    set(rev_date "2019-05-03 16:00:00 -3000")
    set(rev_hash "5CentsCore")
    set(rev_branch "Released")
  else()
