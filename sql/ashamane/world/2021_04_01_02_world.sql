-- -- DB/Creature: Audrey Burnhep <Battle Pet Trainer>
...
-- -----------------------------------------------------------------------
-- DB/Quest: Protect the World Tree Quest chain fixes
...
UPDATE `creature_template` SET `faction`=35,`unit_class`=2,`unit_flags`=72 WHERE `entry`=40180;
